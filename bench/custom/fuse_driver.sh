...
do
	...
	#mkdir -p logs/fuse/${storage}/${scrtype}
	...
	#[YS] cgroup fio
	sudo ./fuse_cgroupset.sh  ${numcore} ${storage} ${scrtype}
	#[YS] cgroup fio
	...
	#[YS] none cgroup fio
	#fio script/4KB-rand-write-${scrtype}.fio | tee logs/fuse/${storage}/${scrtype}/fuse_write_${storage}_${numcore}.log
	#[YS] none cgroup fio
